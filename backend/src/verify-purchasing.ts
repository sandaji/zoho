import { PurchaseOrderStatus } from "./generated/client";
...
async function main() {
  ...
  try {
    ...
    if (!receivedPo) throw new Error("PO not found after partial receive");
    ...
    if (!finalPo) throw new Error("PO not found after full receive");
