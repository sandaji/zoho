...
import { RBACService } from "@core/middleware/rbac.service";
...
export class SalesController {
      ...
      const documentTypes = [
        {
          value: "DRAFT",
          label: "Draft",
          description: "Temporary document that can be converted to invoice",
        },
        {
          value: "QUOTE",
          label: "Quote",
          description: "Price quotation for customer approval",
        },
        {
          value: "INVOICE",
          label: "Invoice",
          description: "Final sales document with payment tracking",
        },
        {
          value: "CREDIT_NOTE",
          label: "Credit Note",
          description: "Document for returns/refunds",
        },
      ];
  ...
  static async updateDocumentItems(
    ...
    try {
      ...
      const updated = await SalesService.updateDocumentItems(
        id,
        branchId,
        userId,
        {
