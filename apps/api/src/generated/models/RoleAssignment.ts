...
export type RoleAssignmentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "roleId", ExtArgs["result"]["roleAssignment"]>
...
export interface RoleAssignmentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const roleAssignmentWithUserIdOnly = await prisma.roleAssignment.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many RoleAssignments and only return the `userId`
   * const roleAssignmentWithUserIdOnly = await prisma.roleAssignment.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more RoleAssignments and only return the `userId`
   * const roleAssignmentWithUserIdOnly = await prisma.roleAssignment.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
